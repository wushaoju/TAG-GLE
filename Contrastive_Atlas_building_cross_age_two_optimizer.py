...
def train_network(index, output_folder, trainloader, aveloader, train_restloader, net, net_rest, para, criterion, optimizer, optimizer2, at_lr, DistType, RegularityType, weight_dist, weight_reg, xDim, yDim, zDim, im_info, dev):
    ...
    output_folder = output_folder + 'check_atlas_target_13_rest_4_to_18_CL_' + str(index)
...
def main():
    ...
    for i in range(0,5):
        ...
        para.model.contrastive_weight = contrastive_weight_index[i]
        dataset = SData('./data_json/data_target_13_rest_LOO.json', "train")
        dataset_rest = SData('./data_json/data_target_13_rest_LOO.json', "train_rest")
        ave_data = SData('./data_json/data_target_13_rest_LOO.json', 'linear')
