...
def main():
    ...
    for i in range(4,19):
        ...
        ave_data = SData(folder_name+str(i)+'_rest_LOO.json', 'linear')
        dataset = SData(folder_name+str(i)+'_rest_LOO.json', "train")
        ...
        checkpoint = torch.load('./check_atlas_male/check_atlas_target_'+str(i)+'_rest_LOOCL'+'/trained_model/model_atlas_weights.pth') ###########Change this
    ...
    scipy.io.savemat("Contrastive_learning_evaluation.mat", {"Dice_score": Dice_score, "VD_score": VD_score, "ASD_scoree": ASD_score})
