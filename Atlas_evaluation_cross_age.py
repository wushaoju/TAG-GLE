...
def main():
    ...
    for i in range(13,14):
        ...
        folder_name = './data_json/data_target_'
        #folder_name = './data_json/data_'
        output_folder = './check_atlas_male/'
        for j in range(0,5):
            atlas_path = './check_atlas_male/check_atlas_target_'+str(i)+'_rest_4_to_12_CL_' + str(j)+'/atlas_1000_1.nii.gz' 
            dataset = SData(folder_name+str(i)+'_rest_4_12.json', "train_rest")
            ave_data = SData(folder_name+str(i)+'_rest_4_12.json', 'linear')
            ...
            checkpoint = torch.load('./check_atlas_male/check_atlas_target_'+str(i)+'_rest_4_to_12_CL_'+str(j)+'/trained_model/model_cross_weights.pth') ###########Change this
            ...
            Dice = test_network(j, output_folder, trainloader, atlas_path, net, para, criterion, NCC, 'l2', para.model.dist, para.model.reg, xDim, yDim, zDim, im_info, dev, i)
